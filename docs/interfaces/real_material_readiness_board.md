...
| `objective_1_pr5_hardware` | `Objective 1`, `PR #5`, `PRRT_kwDOSWB9286CJ3tX` | `robot-hardware-engineer` | Missing real WAVE ROVER/UART/HIL packet and PR #5 2D LiDAR / ToF real materials. |
