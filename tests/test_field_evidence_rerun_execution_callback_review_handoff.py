#!/usr/bin/env python3
"""field_evidence_rerun_execution_callback_review_handoff 的离线围栏测试。"""
...
import field_evidence_rerun_execution_callback_review_handoff as gate  # noqa: E402


# 测试约束 01：fixture 只表达 safe review-decision summary，不创建真实材料目录。
# 测试约束 02：ready case 只证明 metadata handoff 可复账。
...
class FieldEvidenceRerunExecutionCallbackReviewHandoffTest(unittest.TestCase):
    def _summary(
        self,
        evidence_ref: str = "ev-field-handoff-001",
        review_decision: str = "ready",
        **extra: object,
    ) -> dict[str, object]:
        # summary fixture 沿用 execution_callback_review_decision 的 safe summary contract。
        payload: dict[str, object] = {
            "schema": "trashbot.field_evidence_rerun_execution_callback_review_decision_summary.v1",
            "schema_version": 1,
            ...
            "owner_handoff": {
                ...
                "handoff_status": f"{review_decision}_field_evidence_rerun_execution_callback_review_not_proven",
    ...
    def _artifact(self, summary: dict[str, object]) -> dict[str, object]:
        ...
        return {
            "schema": "trashbot.field_evidence_rerun_execution_callback_review_decision.v1",
            "schema_version": 1,
            "source": "software_proof",
            "evidence_boundary": "software_proof_docker_field_evidence_rerun_execution_callback_review_decision_gate",
    ...
    def test_ready_review_decision_maps_to_ready_handoff_boundary(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            summary_path = self._write(root, "summary.json", self._summary())

            artifact, summary, exit_code = gate.build_field_evidence_rerun_execution_callback_review_handoff(
                summary_path,
                "ev-field-handoff-001",
            )

        self.assertEqual(exit_code, 0)
        self.assertEqual(artifact["schema"], "trashbot.field_evidence_rerun_execution_callback_review_handoff.v1")
        self.assertEqual(summary["schema"], "trashbot.field_evidence_rerun_execution_callback_review_handoff_summary.v1")
        self.assertEqual(summary["evidence_boundary"], "software_proof_docker_field_evidence_rerun_execution_callback_review_handoff_gate")
        self.assertEqual(summary["handoff_status"], "ready_for_field_evidence_rerun_execution_callback_review_handoff")
        self.assertEqual(summary["source_review_decision"], "ready")
    ...
    def test_missing_rejected_and_blocked_decisions_map_to_handoff_states(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            missing_artifact, missing_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(missing_path, "")
            rejected_artifact, rejected_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(rejected_path, "")
            blocked_artifact, blocked_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(blocked_path, "")
        ...
        self.assertEqual(blocked_artifact["handoff_status"], "needs_field_evidence_rerun_execution_callback_rerun")
    ...
    def test_bad_json_unsupported_mismatch_and_weak_same_ref_fail_closed(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            missing_artifact, _missing_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(str(root / "missing.json"), "")
            bad_artifact, _bad_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(str(bad_json), "")
            unsupported_artifact, _unsupported_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(wrong_schema, "")
            mismatch_artifact, _mismatch_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(mismatch, "ev-field-handoff-001")
            weak_artifact, _weak_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(weak_same_ref, "")
            ready_artifact, _ready_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(ready_path, "ev-field-handoff-001")

        self.assertEqual(missing_artifact["handoff_status"], "needs_field_evidence_rerun_execution_callback_rerun")
        self.assertEqual(bad_artifact["handoff_status"], "needs_field_evidence_rerun_execution_callback_rerun")
        self.assertEqual(unsupported_artifact["handoff_status"], "needs_field_evidence_rerun_execution_callback_rerun")
        ...
        self.assertEqual(ready_artifact["handoff_status"], "ready_for_field_evidence_rerun_execution_callback_review_handoff")
    ...
    def test_unsafe_copy_and_success_claim_fail_closed_without_leaking_raw_text(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            unsafe_artifact, unsafe_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(unsafe_path, "")
            success_artifact, _success_summary, _ = gate.build_field_evidence_rerun_execution_callback_review_handoff(success_path, "")
    ...
    def test_wrapper_nested_artifact_and_non_access_scope_are_supported(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            artifact, out_summary, _exit_code = gate.build_field_evidence_rerun_execution_callback_review_handoff(wrapper_path, "")

        self.assertEqual(artifact["handoff_status"], "ready_for_field_evidence_rerun_execution_callback_review_handoff")
