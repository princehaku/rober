...
export interface RobotControlActionStatusCard {
  ...
  evidence?: {
    ...
    command_raw_nonzero_proven?: boolean;
    command_raw_lr_nonzero_proven?: boolean;
    command_raw_twist_nonzero_proven?: boolean;
    command_raw_latest_left?: string;
    command_raw_latest_right?: string;
    motion_evidence_complete?: boolean;
    motion_evidence_source?: string;
    wheel_feedback_lr_nonzero_proven?: boolean;
...
export interface RobotControlLiveClosureSummary {
  ...
  keyboard_command_raw_motion_verified: boolean;
  keyboard_command_raw_lr_nonzero_proven: boolean;
  keyboard_motion_evidence_complete: boolean;
  keyboard_wheel_feedback_lr_nonzero_proven: boolean;
  ...
  map_display_overview_inset_overlays: string[];
...
export interface RobotControlLiveSummaryResponse extends RobotControlLiveClosureSummary {
  ...
  command_raw_latest_left: string;
  command_raw_latest_right: string;
  command_raw_latest_linear_x: string;
  command_raw_latest_angular_z: string;
  motion_evidence_complete: boolean;
  motion_evidence_source: string;
  keyboard_command_raw_lr_nonzero: boolean;
  keyboard_command_raw_latest_left: string;
  keyboard_command_raw_latest_right: string;
  keyboard_motion_evidence_complete: boolean;
...
export interface RobotControlSummaryResponse extends ProofFlags {
  ...
  current_goal_status?: RobotControlGoalChecklistSummary["status"];
  current_goal_status_label?: RobotControlGoalChecklistSummary["status_label"];
  current_goal_total_count?: RobotControlGoalChecklistSummary["total_count"];
  current_goal_done_count?: RobotControlGoalChecklistSummary["done_count"];
  current_goal_remaining_count?: RobotControlGoalChecklistSummary["remaining_count"];
  current_goal_progress_plain?: RobotControlGoalChecklistSummary["progress_plain"];
  current_goal_safety_confirm_needed_count?: RobotControlGoalChecklistSummary["safety_confirm_needed_count"];
  current_goal_motion_needed_count?: RobotControlGoalChecklistSummary["motion_needed_count"];
  current_goal_ready_action_count?: RobotControlGoalChecklistSummary["ready_action_count"];
  current_goal_blocked_action_count?: RobotControlGoalChecklistSummary["blocked_action_count"];
  current_goal_next_action_id?: RobotControlGoalChecklistItemId | "none";
  current_goal_next_action_label?: string;
  current_goal_next_action_plain?: string;
  current_goal_next_action_source_card_id?: RobotControlActionStatusCardId | "none";
  current_goal_next_action_requires_safety_confirm?: boolean;
  current_goal_next_action_requires_motion?: boolean;
  current_goal_next_action_blocks_goal_completion?: boolean;
  current_goal_summary_plain?: RobotControlGoalChecklistSummary["summary_plain"];
  current_goal_move_now_status_plain?: RobotControlGoalChecklistSummary["move_now_status_plain"];
  current_goal_mapping_blockers_plain?: RobotControlGoalChecklistSummary["mapping_blockers_plain"];
  current_goal_incomplete_item_ids?: RobotControlGoalChecklistItemId[];
  current_goal_incomplete_labels?: string[];
  current_goal_missing_ids?: RobotControlGoalChecklistItemId[];
  current_goal_missing_labels?: string[];
  current_goal_next_action_item_ids?: RobotControlGoalChecklistSummary["next_action_item_ids"];
  current_goal_ready_action_ids?: RobotControlGoalChecklistSummary["ready_action_ids"];
  current_goal_ready_action_labels?: string[];
  current_goal_blocked_action_ids?: RobotControlGoalChecklistSummary["blocked_action_ids"];
  current_goal_blocked_ids?: RobotControlGoalChecklistSummary["blocked_action_ids"];
  current_goal_blocked_labels?: string[];
  current_goal_mapping_blocked_only_by_camera?: boolean;
  current_goal_free_move_allowed_while_mapping_blocked?: boolean;
  current_goal_camera_only_blocks_mapping_plain?: string;
  ...
  map_display_direct_map_default_zoom_percent?: RobotControlLiveClosureSummary["map_display_direct_map_default_zoom_percent"];
  map_display_fit_zoom_percent?: RobotControlLiveClosureSummary["map_display_fit_zoom_percent"];
  map_display_max_zoom_percent?: RobotControlLiveClosureSummary["map_display_max_zoom_percent"];
  map_display_overview_inset_visible?: RobotControlLiveClosureSummary["map_display_overview_inset_visible"];
  map_display_overview_inset_zoom_percent?: RobotControlLiveClosureSummary["map_display_overview_inset_zoom_percent"];
  map_display_overview_inset_overlays?: RobotControlLiveClosureSummary["map_display_overview_inset_overlays"];
  map_display_overview_inset_sends_motion?: RobotControlLiveClosureSummary["map_display_overview_inset_sends_motion"];
  ...
  live_wysiwyg_status?: "complete" | "only_camera_hardware_action" | "camera_readback_only" | "radar_map_refresh" | "refresh_current_wysiwyg";
  live_wysiwyg_status_plain?: string;
  camera_wysiwyg_status?: "visible" | "needs_first_frame";
  camera_wysiwyg_next_action_plain?: string;
  radar_map_wysiwyg_status?: "loaded" | "needs_readback_refresh";
  radar_map_wysiwyg_next_action_plain?: string;
  ...
  current_trip_execution_pack_stop_endpoint?: RobotControlNav2RouteAcceptancePacket["stop_endpoint"];
  ...
  current_trip_execution_pack_delivery_success?: RobotControlNav2RouteAcceptancePacket["delivery_success"];
  current_trip_execution_pack_needs_same_window_wheel_rerun?: RobotControlNav2RouteAcceptancePacket["needs_same_window_wheel_rerun"];
  current_trip_execution_pack_delivery_success_required?: RobotControlNav2RouteAcceptancePacket["delivery_success_required"];
  current_trip_execution_pack_latest_raw_left?: RobotControlNav2RouteAcceptancePacket["latest_raw_left"];
  current_trip_execution_pack_latest_raw_right?: RobotControlNav2RouteAcceptancePacket["latest_raw_right"];
  current_trip_execution_pack_feedback_sample_count?: RobotControlNav2RouteAcceptancePacket["feedback_sample_count"];
  current_trip_execution_pack_feedback_nonzero_sample_count?: RobotControlNav2RouteAcceptancePacket["feedback_nonzero_sample_count"];
  ...
  nav2_route_run_status?: RobotControlSummaryResponse["current_trip_execution_pack_status"];
  nav2_route_run_plain?: string;
  nav2_route_run_action_id?: RobotControlSummaryResponse["current_trip_execution_pack_action_id"];
  nav2_route_run_display_label?: RobotControlSummaryResponse["current_trip_execution_pack_display_label"];
  nav2_route_run_start_endpoint?: RobotControlSummaryResponse["current_trip_execution_pack_start_endpoint"];
  nav2_route_run_stop_endpoint?: RobotControlSummaryResponse["current_trip_execution_pack_stop_endpoint"];
  nav2_route_run_readback_endpoints?: RobotControlSummaryResponse["current_trip_execution_pack_readback_endpoints"];
  nav2_route_run_required_success_markers?: RobotControlSummaryResponse["current_trip_execution_pack_required_success_markers"];
  nav2_route_run_missing_evidence?: RobotControlSummaryResponse["current_trip_execution_pack_missing_evidence"];
  nav2_route_run_missing_evidence_labels?: string[];
  nav2_route_run_route_ready_on_map?: RobotControlSummaryResponse["current_trip_execution_pack_route_ready_on_map"];
  nav2_route_run_goal_succeeded?: RobotControlSummaryResponse["current_trip_execution_pack_nav2_goal_succeeded"];
  nav2_route_run_same_window_wheel_lr_nonzero?: RobotControlSummaryResponse["current_trip_execution_pack_same_window_wheel_lr_nonzero"];
  nav2_route_run_delivery_success?: RobotControlSummaryResponse["current_trip_execution_pack_delivery_success"];
  nav2_route_run_needs_same_window_wheel_rerun?: RobotControlSummaryResponse["current_trip_execution_pack_needs_same_window_wheel_rerun"];
  nav2_route_run_delivery_success_required?: RobotControlSummaryResponse["current_trip_execution_pack_delivery_success_required"];
  nav2_route_run_current_gap_plain?: RobotControlSummaryResponse["current_trip_execution_pack_current_gap_plain"];
  nav2_route_run_delivery_next_action_plain?: RobotControlSummaryResponse["current_trip_execution_pack_delivery_next_action_plain"];
  nav2_route_run_requires_safety_confirm?: RobotControlSummaryResponse["current_trip_execution_pack_safety_confirm_required"];
  nav2_route_run_minimal_precheck_safety_only?: RobotControlSummaryResponse["current_trip_execution_pack_minimal_precheck_safety_only"];
  ...
  current_safety_confirm_queue_status?: RobotControlSummaryResponse["current_motion_verification_pack_status"];
  current_safety_confirm_queue_plain?: string;
  current_safety_confirm_queue_action_ids?: RobotControlSummaryResponse["current_motion_verification_pack_action_ids"];
  current_safety_confirm_queue_action_display_labels?: RobotControlSummaryResponse["current_motion_verification_pack_action_display_labels"];
  current_safety_confirm_queue_action_start_endpoints?: RobotControlSummaryResponse["current_motion_verification_pack_action_start_endpoints"];
  ...
  current_safety_confirm_queue_camera_preflight_required?: boolean;
  current_safety_confirm_queue_radar_preflight_required?: boolean;
  current_safety_confirm_queue_operator_report_preflight_required?: boolean;
  current_safety_confirm_queue_route_wysiwyg_preflight_required?: boolean;
  ...
  current_safety_confirm_queue_sends_motion_when_executed?: boolean;
  ...
  current_move_now_action_start_endpoints?: RobotControlSummaryResponse["current_motion_verification_pack_action_start_endpoints"];
  current_move_now_action_stop_endpoints?: RobotControlSummaryResponse["current_motion_verification_pack_action_stop_endpoints"];
  current_move_now_primary_action_id?: RobotControlSummaryResponse["current_motion_verification_pack_primary_action_id"];
  current_move_now_primary_action_display_label?: RobotControlSummaryResponse["current_motion_verification_pack_primary_action_display_label"];
  current_move_now_primary_focus_source_card_id?: RobotControlActionStatusCardId | "none";
  current_move_now_primary_focus_kind?: string;
  current_move_now_primary_focus_button_label?: string;
  current_move_now_mapping_blockers_plain?: string;
  current_move_now_free_move_allowed_while_mapping_blocked?: boolean;
  current_move_now_requires_safety_confirm?: boolean;
  current_move_now_minimal_precheck_safety_only?: boolean;
  current_move_now_camera_preflight_required?: boolean;
  current_move_now_radar_preflight_required?: boolean;
  current_move_now_route_wysiwyg_preflight_required?: boolean;
  current_move_now_sends_motion_when_clicked?: false;
  current_move_now_sends_motion_when_executed?: boolean;
  ...
  current_minimal_precheck_pack_action_start_endpoints?: RobotControlFieldAcceptancePacket["safety_confirm_ready_action_start_endpoints"];
  ...
  current_minimal_precheck_pack_missing_evidence?: string[];
  current_minimal_precheck_pack_missing_evidence_labels?: string[];
  ...
  current_minimal_precheck_pack_operator_report_preflight_required?: boolean;
  current_minimal_precheck_pack_route_wysiwyg_preflight_required?: boolean;
  current_minimal_precheck_pack_camera_and_radar_display_only_for_motion?: boolean;
  current_minimal_precheck_pack_mapping_still_requires_camera_and_radar_ready?: boolean;
  current_minimal_precheck_pack_ready_action_count?: number;
  ...
  current_keyboard_control_pack_stop_endpoint?: RobotControlLiveMotionRunbookItem["stop_endpoint"];
  current_keyboard_control_pack_readback_endpoints?: RobotControlLiveMotionRunbookItem["acceptance_endpoints"];
  current_keyboard_control_pack_post_hold_readback_endpoints?: Array<
    RobotControlLiveClosureSummary["fixed_keyboard_feedback_readback_endpoint"] | RobotControlLiveClosureSummary["fixed_keyboard_summary_endpoint"]
  >;
  ...
  current_keyboard_control_pack_pulse_interval_ms?: RobotControlLiveClosureSummary["keyboard_continuous_pulse_interval_ms"];
  current_keyboard_control_pack_pulse_duration_ms?: RobotControlLiveClosureSummary["keyboard_continuous_pulse_duration_ms"];
  current_keyboard_control_pack_stop_triggers?: RobotControlLiveClosureSummary["keyboard_continuous_stop_triggers"];
  current_keyboard_control_pack_wheel_feedback_acceptance?: RobotControlLiveClosureSummary["keyboard_continuous_wheel_feedback_acceptance"];
  ...
  keyboard_hold_status?: RobotControlSummaryResponse["current_keyboard_control_pack_status"];
  keyboard_hold_plain?: string;
  keyboard_hold_action_id?: RobotControlSummaryResponse["current_keyboard_control_pack_action_id"];
  keyboard_hold_display_label?: RobotControlSummaryResponse["current_keyboard_control_pack_display_label"];
  keyboard_hold_ready?: RobotControlSummaryResponse["current_keyboard_control_pack_ready"];
  keyboard_hold_requires_safety_confirm?: RobotControlSummaryResponse["current_keyboard_control_pack_safety_confirm_required"];
  keyboard_hold_minimal_precheck_safety_only?: RobotControlSummaryResponse["current_keyboard_control_pack_minimal_precheck_safety_only"];
  keyboard_hold_start_endpoint?: RobotControlSummaryResponse["current_keyboard_control_pack_start_endpoint"];
  keyboard_hold_stop_endpoint?: RobotControlSummaryResponse["current_keyboard_control_pack_stop_endpoint"];
  keyboard_hold_readback_endpoints?: RobotControlSummaryResponse["current_keyboard_control_pack_readback_endpoints"];
  keyboard_hold_post_hold_readback_endpoints?: RobotControlSummaryResponse["current_keyboard_control_pack_post_hold_readback_endpoints"];
  keyboard_hold_post_hold_readback_sequence_labels?: string[];
  keyboard_hold_missing_evidence?: RobotControlSummaryResponse["current_keyboard_control_pack_missing_evidence"];
  keyboard_hold_missing_evidence_labels?: string[];
  keyboard_hold_pulse_interval_ms?: RobotControlSummaryResponse["current_keyboard_control_pack_pulse_interval_ms"];
  keyboard_hold_pulse_duration_ms?: RobotControlSummaryResponse["current_keyboard_control_pack_pulse_duration_ms"];
  keyboard_hold_stop_triggers?: RobotControlSummaryResponse["current_keyboard_control_pack_stop_triggers"];
  keyboard_hold_wheel_feedback_acceptance?: RobotControlSummaryResponse["current_keyboard_control_pack_wheel_feedback_acceptance"];
  ...
  current_free_move_control_pack_stop_endpoint?: RobotControlLiveMotionRunbookItem["stop_endpoint"];
  current_free_move_control_pack_latest_endpoint?: RobotControlLiveClosureSummary["fixed_free_roam_latest_endpoint"];
  current_free_move_control_pack_readback_endpoints?: RobotControlLiveMotionRunbookItem["acceptance_endpoints"];
  current_free_move_control_pack_post_start_readback_endpoints?: RobotControlLiveMotionRunbookItem["acceptance_endpoints"];
  ...
  current_free_move_control_pack_without_camera_allowed?: RobotControlLiveClosureSummary["free_move_without_camera_allowed"];
  current_free_move_control_pack_without_radar_allowed?: RobotControlLiveClosureSummary["free_roam_motion_without_radar_allowed"];
  current_free_move_control_pack_blocked_by_camera_wysiwyg?: RobotControlLiveClosureSummary["free_move_blocked_by_camera_wysiwyg"];
  current_free_move_control_pack_blocked_by_radar_wysiwyg?: RobotControlLiveClosureSummary["free_move_blocked_by_radar_wysiwyg"];
  current_free_move_control_pack_mapping_start_ready?: boolean;
  current_free_move_control_pack_mapping_start_missing_reasons?: string[];
  current_free_move_control_pack_post_start_readback_refreshes_latest?: boolean;
  current_free_move_control_pack_post_start_readback_refreshes_map_preview?: boolean;
  current_free_move_control_pack_post_start_readback_refreshes_summary?: boolean;
  ...
  free_move_start_status?: RobotControlSummaryResponse["current_free_move_control_pack_status"];
  free_move_start_plain?: string;
  free_move_start_action_id?: RobotControlSummaryResponse["current_free_move_control_pack_action_id"];
  free_move_start_display_label?: RobotControlSummaryResponse["current_free_move_control_pack_display_label"];
  free_move_start_start_endpoint?: RobotControlSummaryResponse["current_free_move_control_pack_start_endpoint"];
  free_move_start_stop_endpoint?: RobotControlSummaryResponse["current_free_move_control_pack_stop_endpoint"];
  free_move_start_latest_endpoint?: RobotControlSummaryResponse["current_free_move_control_pack_latest_endpoint"];
  free_move_start_readback_endpoints?: RobotControlSummaryResponse["current_free_move_control_pack_readback_endpoints"];
  free_move_start_post_start_readback_endpoints?: RobotControlSummaryResponse["current_free_move_control_pack_post_start_readback_endpoints"];
  free_move_start_post_start_readback_sequence_labels?: string[];
  free_move_start_required_success_markers?: RobotControlSummaryResponse["current_free_move_control_pack_required_success_markers"];
  free_move_start_missing_evidence?: RobotControlSummaryResponse["current_free_move_control_pack_missing_evidence"];
  free_move_start_missing_evidence_labels?: string[];
  free_move_start_proof_status?: RobotControlSummaryResponse["current_free_move_control_pack_proof_status"];
  free_move_start_is_ready?: RobotControlSummaryResponse["current_free_move_control_pack_ready"];
  free_move_start_is_running?: boolean;
  free_move_start_is_complete?: boolean;
  free_move_start_requires_safety_confirm?: RobotControlSummaryResponse["current_free_move_control_pack_safety_confirm_required"];
  free_move_start_minimal_precheck_safety_only?: RobotControlSummaryResponse["current_free_move_control_pack_minimal_precheck_safety_only"];
  free_move_start_camera_preflight_required?: RobotControlSummaryResponse["current_free_move_control_pack_camera_preflight_required"];
  free_move_start_radar_preflight_required?: RobotControlSummaryResponse["current_free_move_control_pack_radar_preflight_required"];
  free_move_start_without_camera_allowed?: RobotControlSummaryResponse["current_free_move_control_pack_without_camera_allowed"];
  free_move_start_without_radar_allowed?: RobotControlSummaryResponse["current_free_move_control_pack_without_radar_allowed"];
  free_move_start_blocked_by_camera_wysiwyg?: RobotControlSummaryResponse["current_free_move_control_pack_blocked_by_camera_wysiwyg"];
  free_move_start_blocked_by_radar_wysiwyg?: RobotControlSummaryResponse["current_free_move_control_pack_blocked_by_radar_wysiwyg"];
  free_move_start_mapping_start_ready?: boolean;
  free_move_start_mapping_start_missing_reasons?: string[];
  free_move_start_post_start_readback_refreshes_latest?: boolean;
  free_move_start_post_start_readback_refreshes_map_preview?: boolean;
  free_move_start_post_start_readback_refreshes_summary?: boolean;
  ...
  current_mapping_control_pack_stop_endpoint?: RobotControlLiveMotionRunbookItem["stop_endpoint"];
  current_mapping_control_pack_preview_endpoint?: RobotControlLiveClosureSummary["fixed_mapping_preview_endpoint"];
  current_mapping_control_pack_readback_endpoints?: RobotControlLiveMotionRunbookItem["acceptance_endpoints"];
  current_mapping_control_pack_post_start_readback_endpoints?: RobotControlLiveMotionRunbookItem["acceptance_endpoints"];
  ...
  current_mapping_control_pack_minimal_precheck_safety_only?: RobotControlLiveMotionRunbookItem["minimal_precheck_safety_only"];
  current_mapping_control_pack_camera_required?: RobotControlLiveClosureSummary["mapping_start_requires_camera_first_frame"];
  current_mapping_control_pack_radar_required?: RobotControlLiveClosureSummary["mapping_start_requires_lidar_fresh"];
  current_mapping_control_pack_camera_ready?: boolean;
  current_mapping_control_pack_radar_ready?: boolean;
  current_mapping_control_pack_camera_blocks_start?: RobotControlLiveClosureSummary["mapping_camera_blocks_start"];
  current_mapping_control_pack_radar_blocks_start?: RobotControlLiveClosureSummary["mapping_lidar_blocks_start"];
  current_mapping_control_pack_only_camera_missing?: boolean;
  current_mapping_control_pack_radar_overlay_wysiwyg_complete?: boolean;
  current_mapping_control_pack_camera_hardware_action_required?: RobotControlLiveClosureSummary["camera_hardware_action_required"];
  current_mapping_control_pack_camera_hardware_action_label?: RobotControlLiveClosureSummary["camera_hardware_action_label"];
  current_mapping_control_pack_camera_recovery_next_action_plain?: RobotControlLiveClosureSummary["camera_recovery_next_action_plain"];
  current_mapping_control_pack_blocks_free_move?: false;
  current_mapping_control_pack_free_move_allowed_while_blocked?: boolean;
  current_mapping_control_pack_post_start_readback_refreshes_free_roam_latest?: boolean;
  current_mapping_control_pack_post_start_readback_refreshes_map_preview?: boolean;
  current_mapping_control_pack_post_start_readback_refreshes_summary?: boolean;
  ...
  mapping_start_gate_status?: RobotControlSummaryResponse["current_mapping_control_pack_status"];
  mapping_start_gate_plain?: string;
  mapping_start_gate_action_id?: RobotControlSummaryResponse["current_mapping_control_pack_action_id"];
  mapping_start_gate_display_label?: RobotControlSummaryResponse["current_mapping_control_pack_display_label"];
  mapping_start_gate_start_endpoint?: RobotControlSummaryResponse["current_mapping_control_pack_start_endpoint"];
  mapping_start_gate_stop_endpoint?: RobotControlSummaryResponse["current_mapping_control_pack_stop_endpoint"];
  mapping_start_gate_preview_endpoint?: RobotControlSummaryResponse["current_mapping_control_pack_preview_endpoint"];
  mapping_start_gate_readback_endpoints?: RobotControlSummaryResponse["current_mapping_control_pack_readback_endpoints"];
  mapping_start_gate_post_start_readback_endpoints?: RobotControlSummaryResponse["current_mapping_control_pack_post_start_readback_endpoints"];
  mapping_start_gate_post_start_readback_sequence_labels?: string[];
  mapping_start_gate_required_success_markers?: RobotControlSummaryResponse["current_mapping_control_pack_required_success_markers"];
  mapping_start_gate_missing_evidence?: RobotControlSummaryResponse["current_mapping_control_pack_missing_evidence"];
  mapping_start_gate_missing_evidence_labels?: string[];
  mapping_start_gate_proof_status?: RobotControlSummaryResponse["current_mapping_control_pack_proof_status"];
  mapping_start_gate_is_ready?: RobotControlSummaryResponse["current_mapping_control_pack_ready"];
  mapping_start_gate_requires_safety_confirm?: RobotControlSummaryResponse["current_mapping_control_pack_requires_safety_confirm"];
  mapping_start_gate_safety_confirm_required_when_executed?: true;
  mapping_start_gate_minimal_precheck_safety_only?: RobotControlSummaryResponse["current_mapping_control_pack_minimal_precheck_safety_only"];
  mapping_start_gate_camera_required?: RobotControlSummaryResponse["current_mapping_control_pack_camera_required"];
  mapping_start_gate_radar_required?: RobotControlSummaryResponse["current_mapping_control_pack_radar_required"];
  mapping_start_gate_camera_ready?: boolean;
  mapping_start_gate_radar_ready?: boolean;
  mapping_start_gate_camera_blocks_start?: RobotControlSummaryResponse["current_mapping_control_pack_camera_blocks_start"];
  mapping_start_gate_radar_blocks_start?: RobotControlSummaryResponse["current_mapping_control_pack_radar_blocks_start"];
  mapping_start_gate_only_camera_missing?: boolean;
  mapping_start_gate_radar_overlay_wysiwyg_complete?: boolean;
  mapping_start_gate_camera_hardware_action_required?: RobotControlSummaryResponse["current_mapping_control_pack_camera_hardware_action_required"];
  mapping_start_gate_camera_hardware_action_label?: RobotControlSummaryResponse["current_mapping_control_pack_camera_hardware_action_label"];
  mapping_start_gate_camera_recovery_next_action_plain?: RobotControlSummaryResponse["current_mapping_control_pack_camera_recovery_next_action_plain"];
  mapping_start_gate_blocks_free_move?: false;
  mapping_start_gate_free_move_allowed_while_blocked?: boolean;
  mapping_start_gate_post_start_readback_refreshes_free_roam_latest?: boolean;
  mapping_start_gate_post_start_readback_refreshes_map_preview?: boolean;
  mapping_start_gate_post_start_readback_refreshes_summary?: boolean;
  ...
  current_camera_wysiwyg_pack_first_frame_ready?: RobotControlLiveClosureSummary["camera_current_visible"];
  current_camera_wysiwyg_pack_shared_preview_current_frame_visible?: RobotControlLiveClosureSummary["camera_shared_preview_current_frame_visible"];
  current_camera_wysiwyg_pack_shared_preview_everyone_can_join?: RobotControlLiveClosureSummary["camera_shared_preview_everyone_can_join"];
  current_camera_wysiwyg_pack_shared_preview_client_count?: RobotControlLiveClosureSummary["live_wysiwyg_camera_shared_preview_client_count"];
  current_camera_wysiwyg_pack_shared_preview_upstream_active?: RobotControlLiveClosureSummary["live_wysiwyg_camera_shared_preview_upstream_active"];
  current_camera_wysiwyg_pack_shared_preview_gap_plain?: RobotControlLiveClosureSummary["camera_shared_preview_gap_plain"];
  current_camera_wysiwyg_pack_source_diagnosis_status?: RobotControlLiveClosureSummary["camera_source_diagnosis_status"];
  ...
  current_camera_wysiwyg_pack_usb_speed?: RobotControlLiveClosureSummary["camera_usb_speed"];
  current_camera_wysiwyg_pack_next_action_plain?: RobotControlLiveClosureSummary["live_wysiwyg_camera_recovery_next_action_plain"];
  current_camera_wysiwyg_pack_sequence?: RobotControlLiveClosureSummary["live_wysiwyg_camera_recovery_sequence"];
  current_camera_wysiwyg_pack_sequence_labels?: RobotControlLiveClosureSummary["live_wysiwyg_camera_recovery_sequence_labels"];
  current_camera_wysiwyg_pack_probe_endpoint?: RobotControlLiveClosureSummary["fixed_camera_probe_endpoint"];
  current_camera_wysiwyg_pack_mjpeg_status_endpoint?: RobotControlLiveClosureSummary["fixed_camera_mjpeg_status_endpoint"];
  current_camera_wysiwyg_pack_summary_endpoint?: RobotControlLiveClosureSummary["fixed_objective_audit_summary_endpoint"];
  current_camera_wysiwyg_pack_blocks_wysiwyg?: boolean;
  current_camera_wysiwyg_pack_blocks_mapping_start?: RobotControlLiveClosureSummary["camera_blocks_mapping_start"];
  ...
  camera_first_frame_fix_status?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_status"];
  camera_first_frame_fix_plain?: string;
  camera_first_frame_fix_missing_evidence?: string[];
  camera_first_frame_fix_missing_evidence_labels?: string[];
  camera_first_frame_fix_visible?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_visible"];
  camera_first_frame_fix_first_frame_ready?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_first_frame_ready"];
  camera_first_frame_fix_shared_preview_current_frame_visible?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_shared_preview_current_frame_visible"];
  camera_first_frame_fix_shared_preview_everyone_can_join?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_shared_preview_everyone_can_join"];
  camera_first_frame_fix_source_diagnosis_status?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_source_diagnosis_status"];
  camera_first_frame_fix_source_diagnosis_not_exclusive?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_source_diagnosis_not_exclusive"];
  camera_first_frame_fix_probe_status?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_first_frame_probe_status"];
  camera_first_frame_fix_failure_reason?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_first_frame_failure_reason"];
  camera_first_frame_fix_low_bandwidth_fallback_attempted?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_low_bandwidth_fallback_attempted"];
  camera_first_frame_fix_low_bandwidth_fallback_min_size?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_low_bandwidth_fallback_min_size"];
  camera_first_frame_fix_software_fallback_exhausted?: boolean;
  camera_first_frame_fix_requires_physical_usb_fix?: boolean;
  camera_first_frame_fix_physical_fix_label?: string;
  camera_first_frame_fix_hardware_action_required?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_hardware_action_required"];
  camera_first_frame_fix_hardware_action_label?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_hardware_action_label"];
  camera_first_frame_fix_usb_full_speed_detected?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_usb_full_speed_detected"];
  camera_first_frame_fix_usb_speed?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_usb_speed"];
  camera_first_frame_fix_sequence?: string[];
  camera_first_frame_fix_sequence_labels?: string[];
  camera_first_frame_fix_probe_endpoint?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_probe_endpoint"];
  camera_first_frame_fix_mjpeg_status_endpoint?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_mjpeg_status_endpoint"];
  camera_first_frame_fix_summary_endpoint?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_summary_endpoint"];
  camera_first_frame_fix_blocks_wysiwyg?: boolean;
  camera_first_frame_fix_blocks_mapping_start?: RobotControlSummaryResponse["current_camera_wysiwyg_pack_blocks_mapping_start"];
  ...
  current_radar_map_wysiwyg_pack_source_point_count?: RobotControlLiveClosureSummary["radar_overlay_source_point_count"];
  current_radar_map_wysiwyg_pack_current_vs_source_plain?: RobotControlLiveClosureSummary["radar_overlay_current_vs_source_plain"];
  current_radar_map_wysiwyg_pack_next_action_plain?: RobotControlLiveClosureSummary["radar_overlay_refresh_next_action_plain"];
  current_radar_map_wysiwyg_pack_sequence?: RobotControlLiveClosureSummary["radar_overlay_recovery_sequence"];
  current_radar_map_wysiwyg_pack_sequence_labels?: RobotControlLiveClosureSummary["live_wysiwyg_radar_map_refresh_sequence_labels"];
  current_radar_map_wysiwyg_pack_refresh_endpoint?: RobotControlLiveClosureSummary["fixed_radar_overlay_refresh_endpoint"];
  current_radar_map_wysiwyg_pack_status_endpoint?: RobotControlLiveClosureSummary["fixed_live_wysiwyg_radar_status_endpoint"];
  current_radar_map_wysiwyg_pack_map_preview_endpoint?: RobotControlLiveClosureSummary["fixed_radar_overlay_map_preview_endpoint"];
  current_radar_map_wysiwyg_pack_summary_endpoint?: RobotControlLiveClosureSummary["fixed_objective_audit_summary_endpoint"];
  current_radar_map_wysiwyg_pack_loaded?: boolean;
  current_radar_map_wysiwyg_pack_needs_refresh?: RobotControlLiveClosureSummary["radar_overlay_needs_refresh"];
  current_radar_map_wysiwyg_pack_blocks_wysiwyg?: RobotControlLiveClosureSummary["radar_overlay_blocks_wysiwyg"];
  ...
  keyboard_command_raw_lr_nonzero?: boolean;
  keyboard_motion_evidence_complete?: boolean;
  keyboard_wheel_feedback_lr_nonzero?: boolean;
  ...
  readback_summary: {
    camera: {
      ...
      first_frame_probe_backend_userptr_attempt_count: string;
      first_frame_probe_backend_userptr_frame_observed: string;
    ...
    base: {
      ...
      command_raw_nonzero_proven: string;
      command_raw_lr_nonzero_proven: string;
      command_raw_twist_nonzero_proven: string;
      command_raw_latest_left: string;
      command_raw_latest_right: string;
      command_raw_latest_linear_x: string;
      command_raw_latest_angular_z: string;
      motion_evidence_complete: string;
      motion_evidence_source: string;
  ...
  safe_command_boundary: {
    ...
    keyboard_manual_command_mode: "ros" | "speed" | "pwm";
...
export interface RobotControlRadarStatusResponse extends ProofFlags {
  ...
  radar_status_map_preview_remote_http_status: number | null;
  radar_status_map_preview_status: string;
...
export interface RobotControlCameraUsbRecoveryProxyResponse extends ProofFlags {
  ...
  uvc_module_reload_requested?: boolean;
  uvc_module_reload_attempted?: boolean;
...
export interface RobotControlBaseCommandProxyResponse extends ProofFlags {
  ...
  command_raw_latest_angular_z?: string;
  imu_attitude_delta_observed?: string;
  manual_imu_attitude_delta_observed?: string;
  imu_roll_delta?: string;
  imu_pitch_delta?: string;
  motion_signal_observed?: string;
  motion_signal_source?: string;
  motion_evidence_complete?: string;
  motion_evidence_source?: string;
  feedback_during_motion_t1001_frame_count?: string;
  feedback_after_stop_t1001_frame_count?: string;
  manual_command_executed?: string;
  auto_stop_executed?: string;
