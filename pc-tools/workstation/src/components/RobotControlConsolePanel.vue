...
const plainMappingStartGateGauge = computed<PlainMappingStartGateGauge>(() => {
  ...
  const nextAction = (() => {
    ...
    if (!radarMap.mapPointsVisible) {
      return "可启动建图记录；刷新地图画面确认雷达点";
    }
  ...
  return {
    ...
    radarMapSourcePointCount: radarMap.mapSourcePointCount,
    mappingStartReady: evidence.mappingStartReady,
    primaryActionKind: evidence.primaryActionKind,
    primaryActionRequestsMapping: evidence.primaryActionRequestsMapping,
    fixedMappingStartEndpoint: evidence.fixedMappingStartEndpoint,
  ...
  <section class="workspace robot-console">
    ...
    >
      ...
      <div
        ...
        :data-live-wysiwyg-missing-surface-refresh-endpoints="plainLiveClosureSummary.live_wysiwyg_missing_surface_refresh_endpoints?.join(',') || 'none'"
        :data-live-wysiwyg-missing-surface-refresh-labels="plainLiveClosureSummary.live_wysiwyg_missing_surface_refresh_labels?.join(',') || 'none'"
        :data-live-wysiwyg-primary-refresh-endpoint="plainLiveClosureSummary.live_wysiwyg_primary_refresh_endpoint"
        :data-live-wysiwyg-primary-refresh-label="plainLiveClosureSummary.live_wysiwyg_primary_refresh_label"
        ...
        :data-live-wysiwyg-camera-source-diagnosis-status="plainLiveClosureSummary.live_wysiwyg_camera_source_diagnosis_status"
        :data-live-wysiwyg-camera-source-diagnosis-not-exclusive="plainLiveClosureSummary.live_wysiwyg_camera_source_diagnosis_not_exclusive"
        ...
        :data-free-move-blocked-by-camera-wysiwyg="String(plainLiveClosureSummary.free_move_blocked_by_camera_wysiwyg)"
        ...
        :data-mapping-acceptance-missing-reasons="plainLiveClosureSummary.mapping_acceptance_missing_reasons.join(',') || 'none'"
        :data-mapping-start-unblock-plain="plainLiveClosureSummary.mapping_start_unblock_plain"
        ...
        :data-keyboard-hold-to-move-required="String(plainLiveClosureSummary.keyboard_hold_to_move_required)"
        :data-keyboard-enabled="String(plainLiveClosureSummary.keyboard_enabled)"
        :data-keyboard-motion-verified="String(plainLiveClosureSummary.keyboard_motion_verified)"
        :data-keyboard-stop-settled-after-pulse="String(plainLiveClosureSummary.keyboard_stop_settled_after_pulse)"
        :data-keyboard-best-continuous-pulse-count="String(plainLiveClosureSummary.keyboard_best_continuous_pulse_count)"
        :data-keyboard-verified-min-forwarded-pulses="String(plainLiveClosureSummary.keyboard_verified_min_forwarded_pulses)"
        :data-keyboard-manual-command-mode="plainLiveClosureSummary.keyboard_manual_command_mode"
        :data-keyboard-continuous-minimal-precheck-safety-only="String(plainLiveClosureSummary.keyboard_continuous_minimal_precheck_safety_only)"
        :data-keyboard-continuous-safety-confirm-required="String(plainLiveClosureSummary.keyboard_continuous_safety_confirm_required)"
        :data-keyboard-continuous-enable-sends-motion="String(plainLiveClosureSummary.keyboard_continuous_enable_sends_motion)"
        :data-keyboard-continuous-hold-to-move-required="String(plainLiveClosureSummary.keyboard_continuous_hold_to_move_required)"
        :data-keyboard-continuous-pulse-interval-ms="String(plainLiveClosureSummary.keyboard_continuous_pulse_interval_ms)"
        :data-keyboard-continuous-pulse-duration-ms="String(plainLiveClosureSummary.keyboard_continuous_pulse_duration_ms)"
        :data-keyboard-continuous-stop-triggers="plainLiveClosureSummary.keyboard_continuous_stop_triggers.join(',')"
        :data-keyboard-continuous-wheel-feedback-acceptance="plainLiveClosureSummary.keyboard_continuous_wheel_feedback_acceptance"
        :data-fixed-keyboard-manual-endpoint="plainLiveClosureSummary.fixed_keyboard_manual_endpoint"
        :data-fixed-keyboard-stop-endpoint="plainLiveClosureSummary.fixed_keyboard_stop_endpoint"
        :data-fixed-keyboard-feedback-readback-endpoint="plainLiveClosureSummary.fixed_keyboard_feedback_readback_endpoint"
        :data-fixed-keyboard-summary-endpoint="plainLiveClosureSummary.fixed_keyboard_summary_endpoint"
        :data-keyboard-continuous-post-hold-feedback-readback-required="String(plainLiveClosureSummary.keyboard_continuous_post_hold_feedback_readback_required)"
        :data-keyboard-continuous-post-hold-summary-refresh-required="String(plainLiveClosureSummary.keyboard_continuous_post_hold_summary_refresh_required)"
        :data-live-motion-runbook-action-ids="plainLiveClosureSummary.live_motion_runbook_action_ids?.join(',') || 'none'"
        :data-live-motion-runbook-ready-action-ids="plainLiveClosureSummary.live_motion_runbook_ready_action_ids?.join(',') || 'none'"
        :data-live-motion-runbook-blocked-action-ids="plainLiveClosureSummary.live_motion_runbook_blocked_action_ids?.join(',') || 'none'"
        :data-live-motion-runbook-primary-action-id="plainLiveClosureSummary.live_motion_runbook_primary_action_id"
        :data-live-motion-runbook-start-endpoints="plainLiveClosureSummary.live_motion_runbook_start_endpoints?.join(',') || 'none'"
        :data-live-motion-runbook-acceptance-endpoints="plainLiveClosureSummary.live_motion_runbook_acceptance_endpoints?.join(',') || 'none'"
        :data-live-motion-runbook-minimal-precheck-safety-only="String(plainLiveClosureSummary.live_motion_runbook_minimal_precheck_safety_only)"
        :data-live-motion-runbook-safety-confirm-required="String(plainLiveClosureSummary.live_motion_runbook_safety_confirm_required)"
        ...
        :data-wheel-rerun-minimal-precheck-safety-only="String(plainLiveClosureSummary.needs_same_window_wheel_rerun && plainLiveClosureSummary.minimal_precheck_safety_only)"
        :data-wheel-rerun-safety-confirm-required="String(plainLiveClosureSummary.needs_same_window_wheel_rerun && plainLiveClosureSummary.safety_confirm_required_for_motion)"
        data-wheel-rerun-camera-preflight-required="false"
        data-wheel-rerun-radar-preflight-required="false"
        data-wheel-rerun-route-wysiwyg-preflight-required="false"
        data-wheel-rerun-blocked-by-camera-wysiwyg="false"
        data-wheel-rerun-blocked-by-radar-wysiwyg="false"
        :data-wheel-rerun-command-mode="plainLiveClosureSummary.wheel_rerun_command_mode"
        :data-wheel-rerun-last-base-command-mode="plainLiveClosureSummary.wheel_rerun_last_base_command_mode"
        :data-wheel-rerun-next-base-command-mode="plainLiveClosureSummary.wheel_rerun_next_base_command_mode"
        :data-wheel-rerun-feedback-sample-count="plainLiveClosureSummary.wheel_rerun_feedback_sample_count"
        :data-wheel-rerun-feedback-nonzero-sample-count="plainLiveClosureSummary.wheel_rerun_feedback_nonzero_sample_count"
        ...
        :data-wheel-rerun-imu-attitude-delta-observed="plainLiveClosureSummary.wheel_rerun_imu_attitude_delta_observed"
      ...
      >
        ...
        <p
          ...
          class="panel-note"
          data-testid="plain-mapping-camera-unblock-plan"
          :data-mapping-start-ready="String(plainLiveClosureSummary.mapping_start_ready)"
          :data-camera-blocks-start="String(plainLiveClosureSummary.mapping_camera_blocks_start)"
          :data-lidar-blocks-start="String(plainLiveClosureSummary.mapping_lidar_blocks_start)"
          :data-allows-free-move="String(plainLiveClosureSummary.mapping_unblock_allows_free_move)"
      ...
      <div v-if="plainSafetyActionItems.length" class="plain-safety-actions" data-testid="plain-safety-actions" aria-label="安全确认后可做">
        ...
        <p
          ...
          :data-radar-map-source-point-count="String(plainMappingStartGateGauge.radarMapSourcePointCount)"
          ...
          <div class="keyboard-direction-pad" data-testid="plain-free-roam-direction-pad">
            ...
            <div class="motion-middle-row">
              ...
              <button
                ...
                data-testid="plain-free-roam-screen-stop"
                data-sends-motion-when-clicked="false"
                data-stop-trigger="click"
                :data-fixed-keyboard-stop-endpoint="plainKeyboardDirectionButtonEvidence.fixedStopEndpoint"
                @click="stopKeyboardControl('free_roam_screen_button_stop')"
              >
                停止
              </button>
              <button
