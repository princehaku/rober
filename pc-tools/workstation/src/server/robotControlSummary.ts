...
export async function buildRobotControlSummary(
  ...
  return {
    ...
    free_move_required_success_marker: (freeMoveRunbookItem?.missing_evidence ?? [])[0] ?? "none",
    ...
    free_roam_start_endpoint: freeMoveRunbookItem?.start_endpoint ?? liveClosureSummary.fixed_free_roam_start_endpoint,
    free_roam_stop_endpoint: freeMoveRunbookItem?.stop_endpoint ?? liveClosureSummary.fixed_free_roam_stop_endpoint,
    free_roam_latest_endpoint: liveClosureSummary.fixed_free_roam_latest_endpoint,
    free_roam_acceptance_endpoints: freeMoveRunbookItem?.acceptance_endpoints ?? [
      liveClosureSummary.fixed_free_roam_latest_endpoint,
      liveClosureSummary.fixed_mapping_preview_endpoint,
      "/api/robot-control/summary",
    ],
    free_roam_readback_endpoints: freeMoveRunbookItem?.acceptance_endpoints ?? [
      liveClosureSummary.fixed_free_roam_latest_endpoint,
      liveClosureSummary.fixed_mapping_preview_endpoint,
      "/api/robot-control/summary",
    ],
    free_roam_required_success_markers: freeMoveRunbookItem?.missing_evidence ?? [],
    free_roam_missing_evidence: freeMoveRunbookItem?.missing_evidence ?? [],
