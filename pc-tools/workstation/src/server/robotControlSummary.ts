...
function buildLiveClosureSummary(
  ...
  const mapDisplayTooSmallNextActionPlain = "PC 首页默认把真实地图按高度撑满主画布；仍觉得小就点“进入地图大屏”打开 /map，或点“细节放大”看局部；/map 只保留缩放、只读刷新和工程观察入口；建图、保存和其他卡片都会收起；不需要先开 RViz2。";
