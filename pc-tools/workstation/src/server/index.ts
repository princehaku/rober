...
function buildRobotControlLiveSummaryResponse(summary: RobotControlSummaryResponse): RobotControlLiveSummaryResponse {
  ...
  return {
    ...
    route_target_current_visible: summary.readback_summary.map.route_target_visible,
...
export function createWorkstationApp(): express.Express {
  ...
  workstationApp.post("/api/robot-control/camera/usb-recovery", async (req, res) => {
    ...
    const responseBody: RobotControlCameraUsbRecoveryProxyResponse = {
      ...
      streamon_success_observed: remote.payload?.streamon_success_observed === true,
      ...
      userptr_zero_byte_no_frame_observed: remote.payload?.userptr_zero_byte_no_frame_observed === true,
      no_query_zero_byte_no_frame_observed: remote.payload?.no_query_zero_byte_no_frame_observed === true,
      userptr_attempt_count: finiteNumber(remote.payload?.userptr_attempt_count) ?? 0,
      no_query_attempt_count: finiteNumber(remote.payload?.no_query_attempt_count) ?? 0,
