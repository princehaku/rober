...
- `hardware-engineer`: no implementation owner in this sprint unless real PR #5 hardware materials appear; if materials appear, Hardware must verify them against `docs/vendor/VENDOR_INDEX.md` and referenced local vendor files before any hardware claim.
