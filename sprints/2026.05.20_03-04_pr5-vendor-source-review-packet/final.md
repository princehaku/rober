...
- `robot-hardware-engineer`：完成 `pc-tools/evidence/pr5_vendor_source_review_packet.py`、focused tests、interface doc、production hardware boundary doc 和 sprint evidence JSON/summary。验证 `test -f docs/vendor/VENDOR_INDEX.md`、`py_compile`、`Ran 5 tests ... OK`、required `rg` 和 scoped diff check passed。
