...
- robot-hardware-engineer：新增 PC review-decision gate、fixtures、测试和硬件说明；必须读取 `docs/vendor/VENDOR_INDEX.md` 和 WAVE ROVER vendor 文件；只消费 intake artifact/summary，不打开串口，不探测 `/dev/*`。
