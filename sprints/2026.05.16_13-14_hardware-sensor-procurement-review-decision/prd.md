...
- 主责：`robot-hardware-engineer`，负责 review decision gate、blocker 分类、next_required_evidence、owner_handoff、rerun_commands 和硬件/source/procurement/material boundary。
