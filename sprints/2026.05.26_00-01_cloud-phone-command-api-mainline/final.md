...
- `PYTHONPATH=onboard/src/ros2_trashbot_behavior python3 -m unittest onboard/src/ros2_trashbot_behavior/test/test_remote_cloud_relay.py -k cloud_phone_command_api`：`Ran 3 tests ... OK`。
...
- 命令入队不等于机器人执行完成；下一轮应推进真实部署链路或 command result reconciliation。
