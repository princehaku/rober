...
2026-06-09 13:48 CST 复测结论保持 blocked：本机 `en0` 为 `192.168.1.3/24`，但 `ssh 192.168.1.11:37878`、`nc 192.168.1.11 37878` 和 `ping 192.168.1.11` 均不可达；`ping 192.168.1.1` 也返回 `No route to host`/100% packet loss。因此下一步应先恢复本机 WiFi/LAN 到网关和上位机的基础可达性，再继续 ROS2 topic smoke。
