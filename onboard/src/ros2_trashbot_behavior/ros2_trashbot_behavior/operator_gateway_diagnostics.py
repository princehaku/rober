...
def _cloud_worker_migration_rehearsal_not_proven(source=None):
    # worker/migration rehearsal 是本地 SQLite 演练摘要，必须持续列出真实生产链路未证明项。
    source = source if isinstance(source, dict) else {}
    values = []
    source_values = source.get("not_proven") if isinstance(source.get("not_proven"), list) else []
    for item in list(source_values) + list(CLOUD_WORKER_MIGRATION_REHEARSAL_REQUIRED_NOT_PROVEN):
        text = str(item or "").strip()
        if text and text not in values:
            values.append(text)
    return values
...
def build_diagnostics_payload(
    ...
    *,
    ...
    mobile_field_material_review_decision_source = (
        latest_status.get("mobile_field_material_review_decision")
        if isinstance(latest_status.get("mobile_field_material_review_decision"), dict)
        else latest_status.get("mobile_field_material_review_decision_summary")
        if isinstance(latest_status.get("mobile_field_material_review_decision_summary"), dict)
        else diagnostics_source.get("mobile_field_material_review_decision")
    ...
    route_task_field_retest_session_handoff_source = (
        ...
        if isinstance(latest_status.get("route_task_field_retest_session_handoff"), dict)
        else latest_status.get("route_task_field_retest_session_handoff_summary")
        if isinstance(latest_status.get("route_task_field_retest_session_handoff_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_session_handoff")
        if isinstance(diagnostics_source.get("route_task_field_retest_session_handoff"), dict)
        else diagnostics_source.get("route_task_field_retest_session_handoff_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_session_handoff_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
    ...
    route_task_field_retest_result_intake_source = (
        ...
        if isinstance(latest_status.get("route_task_field_retest_result_intake"), dict)
        else latest_status.get("route_task_field_retest_result_intake_summary")
        if isinstance(latest_status.get("route_task_field_retest_result_intake_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_result_intake")
        if isinstance(diagnostics_source.get("route_task_field_retest_result_intake"), dict)
        else diagnostics_source.get("route_task_field_retest_result_intake_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_result_intake_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
    ...
    route_task_field_retest_result_reconciliation_source = (
        ...
        if isinstance(latest_status.get("route_task_field_retest_result_reconciliation"), dict)
        else latest_status.get("route_task_field_retest_result_reconciliation_summary")
        if isinstance(latest_status.get("route_task_field_retest_result_reconciliation_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_result_reconciliation")
        if isinstance(diagnostics_source.get("route_task_field_retest_result_reconciliation"), dict)
        else diagnostics_source.get("route_task_field_retest_result_reconciliation_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_result_reconciliation_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
    ...
    route_task_field_retest_acceptance_brief_source = (
        ...
        if isinstance(latest_status.get("route_task_field_retest_acceptance_brief"), dict)
        else latest_status.get("route_task_field_retest_acceptance_brief_summary")
        if isinstance(latest_status.get("route_task_field_retest_acceptance_brief_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_acceptance_brief")
        if isinstance(diagnostics_source.get("route_task_field_retest_acceptance_brief"), dict)
        else diagnostics_source.get("route_task_field_retest_acceptance_brief_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_acceptance_brief_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
    ...
    route_task_field_retest_evidence_dispatch_source = (
        ...
        else latest_status.get("route_task_field_retest_evidence_dispatch_summary")
        if isinstance(latest_status.get("route_task_field_retest_evidence_dispatch_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_evidence_dispatch")
        if isinstance(diagnostics_source.get("route_task_field_retest_evidence_dispatch"), dict)
        else diagnostics_source.get("route_task_field_retest_evidence_dispatch_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_evidence_dispatch_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
    ...
    route_task_field_retest_callback_intake_source = (
        ...
        if isinstance(latest_status.get("route_task_field_retest_callback_intake"), dict)
        else latest_status.get("route_task_field_retest_callback_intake_summary")
        if isinstance(latest_status.get("route_task_field_retest_callback_intake_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_callback_intake")
        if isinstance(diagnostics_source.get("route_task_field_retest_callback_intake"), dict)
        else diagnostics_source.get("route_task_field_retest_callback_intake_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_callback_intake_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
    ...
    route_task_field_retest_review_result_handoff_source = (
        ...
        if isinstance(latest_status.get("route_task_field_retest_review_result_handoff"), dict)
        else latest_status.get("route_task_field_retest_review_result_handoff_summary")
        if isinstance(latest_status.get("route_task_field_retest_review_result_handoff_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_review_result_handoff")
        if isinstance(diagnostics_source.get("route_task_field_retest_review_result_handoff"), dict)
        else diagnostics_source.get("route_task_field_retest_review_result_handoff_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_review_result_handoff_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
    ...
    route_task_field_retest_result_acceptance_packet_source = (
        ...
        if isinstance(latest_status.get("route_task_field_retest_result_acceptance_packet"), dict)
        else latest_status.get("route_task_field_retest_result_acceptance_packet_summary")
        if isinstance(latest_status.get("route_task_field_retest_result_acceptance_packet_summary"), dict)
        else diagnostics_source.get("route_task_field_retest_result_acceptance_packet")
        if isinstance(diagnostics_source.get("route_task_field_retest_result_acceptance_packet"), dict)
        else diagnostics_source.get("route_task_field_retest_result_acceptance_packet_summary")
        if isinstance(diagnostics_source.get("route_task_field_retest_result_acceptance_packet_summary"), dict)
        else diagnostics_source.get("summary")
        if isinstance(diagnostics_source.get("summary"), dict)
        else diagnostics_source.get("diagnostics_summary")
        if isinstance(diagnostics_source.get("diagnostics_summary"), dict)
