...
- 下一轮仍需按 live `OKR.md` 重排。当前 O6 已推进到约 47%，O5 约 46% 成为最低可行动目标；O1/O2/O3/O4 仍受真实硬件、路线和感知证据约束，不能用 Docker/local software proof 冒充 HIL、真实云、4G 或真实送达。
